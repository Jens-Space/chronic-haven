...
export const metadata: Metadata = {
  ...
  icons: [
    ...
    { rel: "icon", url: "/chronic-haven/icons/icon-72x72.png", sizes: "72x72" },
    { rel: "icon", url: "/chronic-haven/icons/icon-96x96.png", sizes: "96x96" },
    { rel: "icon", url: "/chronic-haven/icons/icon-128x128.png", sizes: "128x128" },
    { rel: "icon", url: "/chronic-haven/icons/icon-144x144.png", sizes: "144x144" },
    { rel: "icon", url: "/chronic-haven/icons/icon-152x152.png", sizes: "152x152" },
    { rel: "icon", url: "/chronic-haven/icons/icon-192x192.png", sizes: "192x192" },
    { rel: "icon", url: "/chronic-haven/icons/icon-384x384.png", sizes: "384x384" },
