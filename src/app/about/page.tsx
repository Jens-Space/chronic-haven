    ...
    <div className="min-h-screen p-8 bg-gradient-to-b from-purple-50 to-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          ...
          <Link href="/community" className="inline-flex items-center gap-2 px-6 py-3 bg-pink-500 text-white rounded-full font-bold hover:bg-pink-600 transition-colors shadow-md">
            👋 Join Our Community
          </Link>
          <Link href="/resources" className="inline-flex items-center gap-2 px-6 py-3 bg-teal-500 text-white rounded-full font-bold hover:bg-teal-600 transition-colors shadow-md">
            📚 Explore Resources
          </Link>
        </div>
